...
class WorldBuilder:
    ...
    def update(
        ...
        XLogger.log("class WorldBuilder:", "Update")
        # =========================
        ...
        self.world.semantic_summary()
        XLogger.log("class WorldBuilder:", "End update: "+f"objects={len(perception_state.objects)} " + f"regions={len(perception_state.regions)}")
